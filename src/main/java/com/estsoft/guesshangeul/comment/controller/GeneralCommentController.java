...
public class GeneralCommentController {
	...
	@PostMapping
	public ResponseEntity<CommentResponse> addComment(@RequestBody GeneralCommentRequest request) {
		CommentResponse comment = commentService.addComment(request);
		return ResponseEntity.ok(comment);
	}

	@PutMapping("/{comment_id}")
	public ResponseEntity<CommentResponse> modifyComment(@PathVariable Long comment_id,
