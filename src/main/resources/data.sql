...
VALUES
(1, '가는말이고와야오는말이곱다', '2024-11-12 10:10:00', '상대방에게 하는 행동이 돌아온다.', 0, 'ㄱㄴ ㅁㅇ ㄱㅇㅇ ㅇㄴ ㅁㅇ ㄱㄷ', '2024-11-12 10:10:00', 30, 1, 1),
(2, '호랑이도제말하면온다', '2024-11-12 10:20:00', '말하는 대로 나타나는 상황', 0, 'ㅎㄹㅇㄷ ㅈ ㅁ ㅎㅁ ㅇㄷ', '2024-11-12 10:20:00', 28, 1, 2),
(3, '사공이많으면배가산으로간다', '2024-11-12 10:30:00', '많은 사람이 관여하면 일이 엉망이 된다.', 0, 'ㅅㄱㅇ ㅁㅇㅁ ㅂㄱ ㅅㅇㄹ ㄱㄷ', '2024-11-12 10:30:00', 25, 1, 3),
(4, '빈수레가요란하다', '2024-11-12 10:40:00', '실속 없는 사람일수록 겉으로 더 떠들다.', 0, 'ㅂ ㅅㄹㄱ ㅇㄹㅎㄷ', '2024-11-12 10:40:00', 20, 1, 4),
(5, '고생끝에낙이온다', '2024-11-12 10:50:00', '어려운 시간을 지나면 좋은 결과가 온다.', 0, 'ㄱㅅ ㄲㅇ ㄴㅇ ㅇㄷ', '2024-11-12 10:50:00', 35, 1, 5);

-- 음악 게시판의 초성 퀴즈 예시
INSERT INTO `quiz_post`
(`quiz_post_id`, `answer`, `created_at`, `hint_content`, `is_hidden`, `quiz_title`, `updated_at`, `view`, `quiz_board_id`, `user_id`)
VALUES
(6, '벚꽃엔딩', '2024-11-12 11:10:00', '봄 하면 떠오르는 노래', 0, 'ㅂㄲ ㅇㄷ', '2024-11-12 11:10:00', 50, 2, 1),
(7, '좋은날', '2024-11-12 11:20:00', '아이유의 히트곡, 삼단 고음', 0, 'ㅈㅇ ㄴ', '2024-11-12 11:20:00', 45, 2, 2),
(8, '강남스타일', '2024-11-12 11:30:00', '싸이의 글로벌 히트곡', 0, 'ㄱㄴ ㅅㅌㅇ', '2024-11-12 11:30:00', 48, 2, 3),
(9, '다시여기바닷가', '2024-11-12 11:40:00', '여름을 주제로 한 노래', 0, 'ㄷㅅ ㅇㄱ ㅂㄷㄱ', '2024-11-12 11:40:00', 38, 2, 4),
...
(13, '신과함께', '2024-11-12 12:30:00', '저승 세계를 다룬 한국 영화', 0, 'ㅅㄱㅎㄱ', '2024-11-12 12:30:00', 42, 3, 5),
...
(`quiz_post_id`, `answer`, `created_at`, `hint_content`, `is_hidden`, `quiz_title`, `updated_at`, `view`, `quiz_board_id`, `user_id`)
VALUES
(21, '블랙핑크', '2024-11-12 14:10:00', '세계적인 K-pop 걸그룹', 0, 'ㅂㄹㅍㄱ', '2024-11-12 14:10:00', 55, 5, 1),
(22, '지무비', '2024-11-12 14:20:00', '영화 리뷰 및 분석 채널', 0, 'ㅈㅁㅂ', '2024-11-12 14:20:00', 43, 5, 2),
(23, '스포티비', '2024-11-12 14:30:00', '스포츠 중계 및 분석 채널', 0, 'ㅅㅍㅌㅂ', '2024-11-12 14:30:00', 57, 5, 3),
