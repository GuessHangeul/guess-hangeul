# <img src="/img/logo.png" width="25" height="25"/> ㄴㄹㅁㅆㅁ (초성 퀴즈 커뮤니티)

한글초성 퀴즈를 서로 공유하며 문제를 풀 수 있는 게임 커뮤니티 플랫폼입니다.

### 프로젝트 소개

'ㄴㄹㅁㅆㅁ'는 조선시대 훈민정음 서문의 첫 구절인 '나랏말싸미'에서 영감을 받아 탄생했습니다. <br>
우리의 문화유산인 한글의 특징을 살려 현대적인 퀴즈 플랫폼으로 재탄생시켰습니다. <br>
스마트폰과 함께하는 현대인의 일상 속에서, 자연스럽게 우리말 어휘력을 향상시킬 수 있는 놀이터를 제공해드립니다.
...
* 다양한 주제의 초성 퀴즈를 직접 제작하고 공유 <br>
* 창의적인 문제 출제로 사용자들의 적극적인 참여 유도
...
* 일간 랭킹 시스템으로 사용자 간 건전한 경쟁 유도 <br>
* 상위 랭커에게 주어지는 특별한 권한으로 참여 동기 부여

<br>

#### 서비스 링크

* [사이트 링크](http://15.164.187.253:8080/)
