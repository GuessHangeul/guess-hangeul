...
| 홈페이지 - 일반 권한          | 홈페이지 - 관리자              |
|-----------------------|-------------------------|
| ![image](img/홈일반.png) | ![image](img/관리자권한.png) |

| 일반 게시판                  | 문제 게시판                  |
|-------------------------|-------------------------|
| ![image](img/일반게시판.png) | ![image](img/문제게시판.png) |

| 게시판 생성                  | 랭킹                   |
|-------------------------|----------------------|
| ![image](img/게시판생성.png) | ![image](img/랭킹.png) |
...
| 게시글 추가 - 일반               | 게시글 추가 - 문제               |
|---------------------------|---------------------------|
| ![image](img/일반게시글작성.png) | ![image](img/문제게시글추가.png) |

| 게시글 수정 - 일반               | 게시글 수정 - 문제               |
|---------------------------|---------------------------|
| ![image](img/일반게시글수정.png) | ![image](img/문제게시글수정.png) |
...
| 계정 찾기                    | 비밀번호 변경                    |
|--------------------------|----------------------------|
| ![image](img/계정찾기.png)   | ![image](img/재설정메일.png)    |
| ------------------------ | -------------------------- |
| ![image](img/비밀번호변경.png) | ![image](img/비밀번호재설정.png)  |
